...
def checkInstAndgetPatt(node_i, node_j, instruction_input, lengthOfInst, mat):
...
def checkCopyValidity(node_i, node_j, instruction_input, lengthOfInst, pattern, mat):
    instruction = instruction_input.copy()
    n = len(mat)
    idx_pattern = 0
    idx_istruct = 0
