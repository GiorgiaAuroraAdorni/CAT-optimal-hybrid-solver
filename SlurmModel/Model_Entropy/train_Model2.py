...
def main(filenumber):
    ...
    agent.learn(total_timesteps=5000000, reset_num_timesteps=False, tb_log_name=("log_PPO_graph_"+str(filenumber)+"entropy3"))
    print("____________Save learn____________")
    agent.save("./AI/AI_Graph_"+str(filenumber)+"etpy3.zip")
