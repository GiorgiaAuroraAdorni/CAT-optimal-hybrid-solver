...
def generateAction(n, instructions, patterns):
    actions = []

    for node_i, node_j, instruction_idx, length, pattern_idx in product(
        range(n),
        range(n),
        ...
        action = (node_i, node_j, instruction_idx, length, pattern_idx)
...
class GameEnvironmentTrain(gym.Env):
    def __init__(self, boards,voidMat, max_id, instructions, patterns, num_colors,map_value, n):
        ...
        # Genera tutte le azioni possibili
        self.actions = generateAction(n, instructions, patterns)

        # Definisci lo spazio delle azioni
    ...
    def step(self, action):
        ...
        node_i, node_j, instruction_idx, length, pattern_idx = self.actions[action]
