...
std::vector<std::vector<int>> KmeansPlusPlus(int k_clusters, std::vector<Instruction> Moves, std::vector<std::vector<int>> & finalMat, std::vector<std::vector<int>> & voidMat,std::vector<int> value_index){
